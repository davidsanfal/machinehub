from machinehub.paths import SimplePaths, CONANINFO
from machinehub.model.ref import ConanFileReference, PackageReference
import os
from machinehub.info import SearchInfo
...
class FileManager(object):
    ...
    def __init__(self, paths, file_adapter, search_engine=None):
        ...
        # If search_engine is specified, machinehub will be searched
    ...
    def search(self, pattern=None, ignorecase=True, exclude_index=False):
        """ Get all an info dict from your exported machinehub
        ...
        if not self._search_engine or exclude_index:
            ...
            try:
                ...
                raise MachinehubException("Something went bad with the search. Please try again later.")
