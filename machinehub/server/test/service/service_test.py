import unittest
from machinehub.model.ref import ConanFileReference, PackageReference
from machinehub.server.service.service import ConanService, FileUploadDownloadService
from machinehub.paths import CONAN_MANIFEST, CONANINFO, SimplePaths
from machinehub.util.files import save_files, save, mkdir, load, md5sum
from machinehub.server.service.authorize import BasicAuthorizer
import os
from machinehub.errors import NotFoundException, RequestErrorException
from machinehub.test.utils.test_files import hello_source_files
from machinehub.server.store.disk_adapter import DiskAdapter
from machinehub.server.store.file_manager import FileManager
from machinehub.server.crypto.jwt.jwt_updown_manager import JWTUpDownAuthManager
from datetime import timedelta
from time import sleep
from machinehub.model.info import ConanInfo
from machinehub.model.manifest import FileTreeManifest
from machinehub.test.utils.test_files import temp_folder
...
class ConanServiceTest(unittest.TestCase):
    ...
    def test_search(self):
        ...
        """
        # Creating and saving machinehub, packages, and machinehub.vars
...
"""
    ...
    def remove_test(self):
        ...
        # Delete all the machinehub folder
