import unittest
from machinehub.util.files import save
import os
...
class ServerConfTest(unittest.TestCase):
    ...
    def test_values(self):
        ...
        self.assertEquals(config.disk_storage_path, os.path.normpath(os.path.expanduser("~/.machinehub")))
